    ...
    public function up(): void
    {
        Schema::create('accounting_inventory_transactions', function (Blueprint $table) {
            ...
            $table->foreignId('accounting_doc_transaction_id')
                ->nullable()
                ->constrained('accounting_doc_transactions')
            ...
            $table->foreignId('voided_by')->nullable()->constrained('users')->onDelete(fk_on_delete('set null'));
        ...
        Schema::create('accounting_inventory_transaction_lines', function (Blueprint $table) {
            ...
            $table->foreignId('unit_of_measure_id')->nullable()->constrained('unit_of_measures')->onDelete(fk_on_delete('set null'));
            $table->decimal('unit_cost', 18, 4)->default(0);
            $table->decimal('amount', 18, 4)->default(0);
            $table->decimal('prefill_quantity', 15, 5)->nullable();
            $table->decimal('prefill_unit_cost', 18, 4)->nullable();
        ...
        Schema::create('accounting_inventory_ledger', function (Blueprint $table) {
            ...
            $table->decimal('weighted_unit_cost', 18, 4)->default(0);
