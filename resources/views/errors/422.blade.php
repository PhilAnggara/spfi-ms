        ...
        <div class="error-page container">
            <div class="col-md-8 col-12 offset-md-2">
                <div class="text-center">
                    <img class="img-error" src="{{ url('assets/compiled/svg/error-422.svg') }}" alt="Unprocessable Entity">
                    <h1 class="error-title">Unprocessable Entity</h1>
                    <p class="fs-5 text-gray-600">The submitted data is invalid. Please review the form and try again. If the issue continues, please contact the SPFI IT Department.</p>
