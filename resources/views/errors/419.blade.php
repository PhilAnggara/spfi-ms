        ...
        <div class="error-page container">
            <div class="col-md-8 col-12 offset-md-2">
                <div class="text-center">
                    <img class="img-error" src="{{ url('assets/compiled/svg/error-419.svg') }}" alt="Page Expired">
                    <h1 class="error-title">Page Expired</h1>
                    <p class="fs-5 text-gray-600">Your session has expired. Please refresh the page and try again. If the issue continues, contact the SPFI IT Department.</p>
