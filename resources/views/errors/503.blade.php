        ...
        <div class="error-page container">
            <div class="col-md-8 col-12 offset-md-2">
                <div class="text-center">
                    <img class="img-error" src="{{ url('assets/compiled/svg/error-503.svg') }}" alt="Service Unavailable">
                    <h1 class="error-title">Service Unavailable</h1>
                    <p class="fs-5 text-gray-600">The service is temporarily unavailable. Please try again later. If the issue continues, please contact the SPFI IT Department.</p>
