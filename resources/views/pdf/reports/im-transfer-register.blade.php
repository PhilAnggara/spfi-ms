...
@section('content')
    ...
    @if ($rows->isEmpty())
        <p class="center muted" style="margin-top: 8mm;">No transfer slip records found for the selected filters.</p>
    @else
        <table class="data-table">
            <thead>
                <tr>
                    <th colspan="4" class="center section-head section-sep">Transfer Slip</th>
                ...
                <tr>
                    ...
                    <th class="section-col col-sep">SWS Number</th>
                    <th class="section-col section-sep">Type</th>
                    <th class="section-col section-start section-sep">To Department</th>
                    ...
                    <th class="section-col section-start col-sep right">Request</th>
                    <th class="section-col section-sep right">Transfer</th>
            ...
            <tbody>
                @foreach ($rows as $row)
                    <tr>
                        <td>{{ $row['ts_number'] }}</td>
                        <td class="nowrap-date">{{ $fmtTableDate($row['ts_date']) }}</td>
                        ...
                        <td class="right">{{ $fmtQty($row['transfer_qty']) }}</td>
                        <td>{{ $row['creator'] }}</td>
