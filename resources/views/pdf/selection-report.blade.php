...
<head>
    <meta charset="UTF-8">
    <title>Supplier Selection Report</title>
    <style>
        body {
...
<body>
    ...
    @if ($prsItem->selection_reason)
        <div class="reason-section">
            <div class="reason-title">Selection Reason</div>
            <div class="reason-text">{{ $prsItem->selection_reason }}</div>
        </div>
    @endif
    ...
    <div class="visual-section">
        ...
        @foreach ($canvasingItems as $canvasing)
            ...
            <div class="visual-row">
                ...
                <div class="bar-wrap">
                    <div class="bar {{ $isSelected ? 'bar-selected' : '' }}" style="width: {{ number_format($ratio, 2, '.', '') }}%;"></div>
                </div>
            </div>
        @endforeach
        <div class="footnote">Panjang bar dibandingkan terhadap harga tertinggi pada item yang sama; warna hijau menandai supplier yang dipilih.</div>
    </div>
</body>
</html>
