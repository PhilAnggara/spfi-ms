                            ...
                            <tbody>
                                @foreach ($purchaseOrders as $po)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm po-approval-actions">
                                                @if ($po->status === 'PENDING_APPROVAL')
                                                    <form method="post" action="{{ route('purchase-orders.approve', $po) }}" class="d-inline">
                                                        @csrf
                                                        <button type="submit" class="btn icon" data-bstooltip-toggle="tooltip" data-bs-placement="top" title="Approve">
                                                            <i class="fa-light fa-circle-check text-success"></i>
                                                        </button>
                                                    </form>
                                                    <button type="button" class="btn icon" data-bs-toggle="modal" data-bs-target="#requestChanges-{{ $po->id }}" data-bstooltip-toggle="tooltip" data-bs-placement="top" title="Request Changes">
                                                        <i class="fa-light fa-arrows-rotate text-warning"></i>
                                                    </button>
                                                @endif
                                                <button type="button" class="btn icon" data-bs-toggle="modal" data-bs-target="#poDetail-{{ $po->id }}" data-bstooltip-toggle="tooltip" data-bs-placement="top" title="Detail">
