...
@section('content')
    ...
    <script id="canvasing-supplier-term-map" type="application/json">@json($supplierTermMap)</script>
    <script id="canvasing-supplier-list" type="application/json">@json($supplierList)</script>
@endsection

@push('addon-style')
    <link rel="stylesheet" href="{{ url('assets/css/modules/canvasing-detail.css') }}">
@endpush

@push('addon-script')
    <script src="{{ url('assets/scripts/modules/canvasing-detail.js') }}"></script>
@endpush
