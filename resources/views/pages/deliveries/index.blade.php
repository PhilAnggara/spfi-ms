...
@push('addon-style')
    ...
    <style>
        ...
        .delivery-detail-table thead th {
            background: #f8fafc;
            border-bottom: 1px solid #e2e8f0;
            font-size: 0.75rem;
        ...
        (function () {
            ...
            async function replacePageContent(url, pushState = true) {
                ...
                try {
                    ...
                    const newContainer = doc.querySelector('#delivery-page-container');
                    const currentContainer = document.querySelector('#delivery-page-container');
