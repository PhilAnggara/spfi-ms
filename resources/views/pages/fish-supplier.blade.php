                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <button type="button" class="btn icon" data-bstooltip-toggle="tooltip" data-bs-placement="top" title="Delete" onclick="hapusData({{ $supplier->id }}, 'Delete Fish Supplier', 'Are you sure want to delete {{ $supplier->name }}?')">
                                            <i class="fa-light fa-trash text-secondary"></i>
                                        </button>
                                        <form action="{{ route('fish-supplier.destroy', $supplier->id) }}" id="hapus-{{ $supplier->id }}" method="POST">
                                            @method('delete')
                                            @csrf
                                        </form>
                                    </div>
...
@include('includes.modals.fish-supplier-modal')
@endsection
