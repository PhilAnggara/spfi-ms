...
<div
	...
	data-edit-modal-id="{{ session('editing_fish_id') ? 'edit-modal-' . session('editing_fish_id') : '' }}"
	data-alt-modal-id="{{ session('size_modal_fish_id') ? 'size-modal-' . session('size_modal_fish_id') : '' }}"
